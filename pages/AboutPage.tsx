            ...
            <div className="container mx-auto px-4 py-16 sm:py-24">
                ...
                <section className="text-center mb-16">
                    <AnimateOnScroll animationType="zoom-in">
                        <h1 className="text-4xl sm:text-6xl text-highlight font-serif">Sobre {companyInfo.name}</h1>
                    </AnimateOnScroll>
                ...
                <section className="grid md:grid-cols-2 gap-8 items-stretch mb-16">
                    <AnimateOnScroll animationType="slide-in-left">
                        <GlassPanel className="h-full interactive-panel">
                            <i className="fas fa-bullseye text-4xl text-primary mb-4"></i>
                            <h2 className="text-2xl font-bold mb-3 text-highlight">Nuestra Misión</h2>
                            <p className="text-text-light/70">{companyInfo.mission}</p>
                        </GlassPanel>
                    </AnimateOnScroll>
                    <AnimateOnScroll delay={150} animationType="slide-in-right">
                        <GlassPanel className="h-full interactive-panel">
                            <i className="fas fa-eye text-4xl text-primary mb-4"></i>
                            <h2 className="text-2xl font-bold mb-3 text-highlight">Nuestra Visión</h2>
                            <p className="text-text-light/70">{companyInfo.vision}</p>
                        </GlassPanel>
                    </AnimateOnScroll>
                </section>
                ...
                <section className="grid md:grid-cols-2 gap-8 items-center mb-16">
                    <AnimateOnScroll delay={200} animationType="slide-in-left">
                        <GlassPanel className="h-full interactive-panel flex flex-col justify-center">
                            <i className="fas fa-moon text-4xl text-primary mb-4"></i>
                            <h2 className="text-2xl font-bold mb-3 text-highlight">Nuestra Inspiración</h2>
                            <p className="text-text-light/70">{companyInfo.inspiration}</p>
                        </GlassPanel>
                    </AnimateOnScroll>
                ...
                <section className="mt-16">
                    <AnimateOnScroll>
                        <h2 className="text-4xl sm:text-5xl font-bold text-center text-highlight mb-12 font-serif">Valores que Nos Definen</h2>
                    </AnimateOnScroll>
                        ...
                        {companyInfo.values.map((value, index) => (
                            <AnimateOnScroll key={value.title} delay={index * 100}>
                                <GlassPanel className="text-center h-full interactive-panel">
                                    ...
                                    <h3 className="text-lg font-bold mb-2 text-highlight">{value.title}</h3>
                                    <p className="text-text-light/70 text-sm">{value.description}</p>
                                </GlassPanel>
                            </AnimateOnScroll>
                        ))}
                    </div>
