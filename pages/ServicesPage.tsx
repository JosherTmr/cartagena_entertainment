            ...
            <div className="relative w-full">
                {activeDestination ? (
                    ...
                    <div className="relative w-full h-[50vh] md:h-[60vh] min-h-[400px] flex items-center justify-center mb-12 md:mb-16 overflow-hidden">
                        ...
                        <div className="relative z-10 container mx-auto px-4 text-center pt-16 md:pt-10">
                            <AnimateOnScroll animationType="zoom-in">
                                ...
                                <h1 className="text-4xl sm:text-6xl md:text-8xl text-text-light font-serif drop-shadow-2xl mb-4 md:mb-6 tracking-tight leading-tight">
                                    {title}
                                </h1>
                            </AnimateOnScroll>

                            <AnimateOnScroll delay={200} animationType="fade-up">
                                <div className="w-16 md:w-24 h-1 bg-primary mx-auto mb-4 md:mb-6 rounded-full opacity-80 shadow-[0_0_10px_var(--primary)]"></div>
                                <p className="max-w-3xl mx-auto text-base sm:text-lg md:text-2xl text-text-light/90 font-light drop-shadow-lg leading-relaxed px-2">
                                    {description}
                                </p>
                            </AnimateOnScroll>
                        </div>
                    ...
                    <div className="container mx-auto px-4 pt-24 pb-8 md:pt-32 md:pb-12 text-center relative">
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-64 bg-primary/10 blur-[100px] rounded-full pointer-events-none -z-10"></div>

                        <AnimateOnScroll animationType="fade">
                            <h1 className="text-3xl sm:text-5xl md:text-6xl text-highlight font-serif mb-4 md:mb-6">{title}</h1>
                        </AnimateOnScroll>
                        <AnimateOnScroll delay={200} animationType="fade">
                            <div className="w-16 h-1 bg-white/20 mx-auto mb-6 rounded-full"></div>
                            <p className="max-w-3xl mx-auto text-lg text-text-light/80 leading-relaxed">
                                {description}
                            </p>
                        </AnimateOnScroll>
                    </div>
            ...
            <div className="container mx-auto px-4 pb-20">
                <section className="relative z-20">
                    {filteredServices.length > 0 ? (
                        ...
                        <AnimateOnScroll animationType="fade">
                            <div className="text-center py-20 bg-glass-bg rounded-3xl backdrop-blur-glass border border-glass-border max-w-2xl mx-auto">
                                <div className="w-20 h-20 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-6">
                                    <i className="fas fa-search text-3xl text-primary"></i>
                                </div>
                                <h3 className="text-2xl font-bold text-highlight mb-2">No se encontraron servicios</h3>
                                <p className="text-text-light/60 px-6">
