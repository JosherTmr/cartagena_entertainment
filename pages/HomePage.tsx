...
const HomePage: React.FC = () => {
  ...
  const headVariants = {
    initial: {
      ...
      ...(!isMobile && {
        color: "var(--bg-dark)",
        backgroundColor: "rgba(89, 180, 163, 0.85)", // Keppel with opacity
    ...
    hovered: {
      ...
      color: "var(--text-light)",
      backgroundColor: "rgba(33, 25, 22, 0.8)", // Licorice with opacity
        ...
        <div className="container mx-auto px-4 py-12 md:py-20">
          ...
          <section className="mb-16 md:mb-24">
            <AnimateOnScroll animationType="zoom-in">
              <h2 className="text-3xl sm:text-5xl text-center text-highlight mb-8 md:mb-12 font-serif">
            ...
            >
              {featuredDestinations.map((dest, index) => (
                ...
                >
                  ...
                  >
                    <motion.span variants={titleVariants} className="font-serif tracking-wide">
                      {dest.name}
                    </motion.span>
          ...
          <section className="mb-24">
            <AnimateOnScroll animationType="fade">
              <h2 className="text-4xl sm:text-5xl text-center text-highlight mb-12 font-serif">Atrevete a vivir experiencias exclusivas</h2>
            </AnimateOnScroll>
            <AnimateOnScroll animationType="zoom-in">
          ...
          <section>
            <AnimateOnScroll animationType="zoom-in">
              <h2 className="text-4xl sm:text-5xl text-center text-highlight mb-12 font-serif">¿Por Qué Elegirnos?</h2>
            </AnimateOnScroll>
            <div className="grid md:grid-cols-3 gap-8">
              <AnimateOnScroll delay={0} animationType="slide-in-left">
                <GlassPanel className="text-center interactive-panel">
                  <i className="fas fa-gem text-4xl text-primary mb-4"></i>
                  <h3 className="text-xl font-bold mb-2 text-highlight">Exclusividad</h3>
                  <p className="text-text-light/70">Servicios y propiedades de lujo seleccionados para una experiencia única.</p>
                </GlassPanel>
              </AnimateOnScroll>
              <AnimateOnScroll delay={150} animationType="fade-up">
                <GlassPanel className="text-center interactive-panel">
                  <i className="fas fa-user-shield text-4xl text-primary mb-4"></i>
                  <h3 className="text-xl font-bold mb-2 text-highlight">Privacidad y Seguridad</h3>
                  <p className="text-text-light/70">Máxima discreción y personal de seguridad para tu tranquilidad.</p>
                </GlassPanel>
              </AnimateOnScroll>
              <AnimateOnScroll delay={300} animationType="slide-in-right">
                <GlassPanel className="text-center interactive-panel">
                  <i className="fas fa-concierge-bell text-4xl text-primary mb-4"></i>
                  <h3 className="text-xl font-bold mb-2 text-highlight">Servicio Personalizado</h3>
                  <p className="text-text-light/70">Atención 24/7 y un equipo de concierge dedicado a tus deseos.</p>
                </GlassPanel>
              </AnimateOnScroll>
            </div>
          </section>
